const closer1 = document.getElementById("faqcloser")
...
f1.addEventListener("click", () => {
    if (yoyo === false) {
        ...
        closer1.classList.add("rotate45")
        closer1.classList.remove("rotate-45")
        f1.style.backgroundColor = "#fcba00"
        yoyo = true
    } else {
        answer.classList.add("answer-off")
        answer.classList.remove("answer")
        closer1.classList.remove("rotate45")
        closer1.classList.add("rotate-45")
